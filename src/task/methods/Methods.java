...
public class Methods {
    public static void main(String[] args) {
        ...
        System.out.println(stringInt("14", 4));
        System.out.println(isStringLess("2", 4));
        System.out.println(isBollian(false, false));
...
//  обернуть их в строку и вернуть результат строкой
    public static String stringInt(String str, int a) {
...
//  если обе false верни false
    public static boolean isBollian(boolean a, boolean b) {
        if (a || b) {
            return true;
        } else {
            return false;
